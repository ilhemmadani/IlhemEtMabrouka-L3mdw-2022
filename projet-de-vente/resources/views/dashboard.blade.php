   ...
   <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active" data-bs-interval="1500">
        <img src="assets/img/7.jpg"height="400px" class="d-block w-100"  alt="...">
      ...
      <div class="carousel-item" data-bs-interval="1500">
        <img src="assets/img/8.jpg" height="100px"class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
      ...
      <div class="carousel-item">
        <img src="assets/img/5.jpg"height="400px" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
        <img src="assets/img/c.jpg"height="400px" class="d-block w-100" alt="...">
        <div class="carousel-caption d-none d-md-block">
...
de proposer des projets, répondre à diverses problématiques.</p>
                   ...
                   <b align="right"margin-left="40px"><i class="fa fa-map-marker"></i> RUE 20 MARS TAUORIT HOUMET SOUK DJERBA </b></br>
